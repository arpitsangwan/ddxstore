$(document).ready(function(){
  ...
  //   $('.product').removeClass('col-3').each(function(){											
	// 	});			
	// 	$('.product').addClass('large col-6').each(function(){											
	// 	});				
	// 	$('.info-large').addClass('col-6').each(function(){											
	// 	});				
  //   $('.product .make3D').removeClass('col-12').each(function(){											
	// 	});						
  //   $('.product .make3D').addClass('col-6').each(function(){											
	// 	});						
  ...
  //   $('.product').removeClass('large col-6');			
	// 	$('.product').addClass('col-3');
